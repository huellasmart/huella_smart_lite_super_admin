...
export default function FactorCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCONCATENADO(initialValues.CONCATENADO);
    setCOMBUSTIBLE(initialValues.COMBUSTIBLE);
    setCONTAMINANTE(initialValues.CONTAMINANTE);
    setINCERTIDUMBRE(initialValues.INCERTIDUMBRE);
    setVALORFE(initialValues.VALORFE);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Factor(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FactorCreateForm")}
      {...rest}
    >
      <TextField
        label="Cod"
