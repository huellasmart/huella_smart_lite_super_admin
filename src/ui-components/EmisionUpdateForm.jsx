...
export default function EmisionUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = emisionRecord
      ? { ...initialValues, ...emisionRecord, userID, companyID }
      : initialValues;
    ...
    setCANTIDAD(cleanValues.CANTIDAD);
    setCO2(cleanValues.CO2);
    setCH4(cleanValues.CH4);
    setN2O(cleanValues.N2O);
    setSF6(cleanValues.SF6);
    setHFC(cleanValues.HFC);
    setPFC(cleanValues.PFC);
    setNF3(cleanValues.NF3);
    setInicioPeriodo(cleanValues.InicioPeriodo);
    setTerminoPeriodo(cleanValues.TerminoPeriodo);
  ...
  React.useEffect(resetStateValues, [emisionRecord, userID, companyID]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Emision.copyOf(emisionRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "EmisionUpdateForm")}
      {...rest}
    >
      <TextField
        label="Company"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || emisionModelProp)}
